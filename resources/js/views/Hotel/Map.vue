<template>
  ...
  >
    ...
    >
      <l-tooltip :content="tooltipContent" :options="{ permanent: false }" />
    </l-marker>
  </l-map>
</template>
<script>
...
export default {
  ...
  mounted() {
    ...
    if(this.contacts.display_name){
        this.position = {lat: this.contacts.latitude, lng:this.contacts.longitude };
      }
